...
using ISimpleAuthorizationService = Simple.Auth.Interfaces.Authentication.IAuthorizationService;

namespace Simple.Auth.Middleware.Handlers
{
    public class SimpleRequirementHandler : AuthorizationHandler<SimpleRequirement>
    {
        ...
        public SimpleRequirementHandler(ICorrelationLoggerFactory loggerFactory, ISimpleAuthorizationService authorizationService,
            ICorrelationService correlationService)
        {
            _logger = loggerFactory.CreateLogger<SimpleRequirementHandler>();
        ...
        {
            var tokenExpiry = _authorizationService.GetTokenExpiry();
            ...
            return await _authorizationService.TryRefreshAccessAsync();
        }
